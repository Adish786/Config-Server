# Spring Boot "Config-Server Microservice"
...
* Inside a Config Server Microservice Configure the all common properties inside a  Product-Service,Payment-Service,Order-Service,Shopping-Service configured call the common-config folder and after that created the application properties and defined it 
* It is simplecity for the common properties collection
